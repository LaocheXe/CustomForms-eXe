...
//include_once($prevFolder."_setup.php"); // Used to get the config file - e107 doesnt need it
//include_once($prevFolder."classes/customform.php"); // Updated to customform_class.php
include_once("customform_class.php"); // Needs to be update for e107 plugin standard
